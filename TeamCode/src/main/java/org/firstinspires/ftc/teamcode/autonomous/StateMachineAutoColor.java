...
@Autonomous
public class StateMachineAutoColor extends OpMode {
    ...
    public void init() {
        ...
        stateMachine = new StateMachine(new AutoState[] {
                ...
                new AutoState(new AutoState.ContinueCondition(   AutoState.ContinueType.TIME,    500L,   6),  new AutoState.StateAction(AutoState.ActionType.DRIVE,          new float[] {0f,0f,0f}             )),
                new AutoState(new AutoState.ContinueCondition(   AutoState.ContinueType.TIME,    500L,   7),  new AutoState.StateAction(AutoState.ActionType.DRIVE,          new float[] {0,-0.4f,0}            )),
                new AutoState(new AutoState.ContinueCondition(   AutoState.ContinueType.TIME,    500L,   8),  new AutoState.StateAction(AutoState.ActionType.DRIVE,          new float[] {0f,0f,0f}             )),
                ...
                new AutoState(new AutoState.ContinueCondition(   AutoState.ContinueType.TIME,    1_000L, 11),  new AutoState.StateAction(AutoState.ActionType.MANIP_SERVO,    new float[] {0f, 0f}              )),
                new AutoState(new AutoState.ContinueCondition(   AutoState.ContinueType.TIME,    1_000L, 12),  new AutoState.StateAction(AutoState.ActionType.MANIP_SERVO,    new float[] {0f, 0.7f}            )),
                new AutoState(new AutoState.ContinueCondition(   AutoState.ContinueType.TIME,    1_000L, 13),  new AutoState.StateAction(AutoState.ActionType.MANIP_SERVO,    new float[] {0f, 0f}              )),
                new AutoState(new AutoState.ContinueCondition(   AutoState.ContinueType.TIME,    1_000L, 14), new AutoState.StateAction(AutoState.ActionType.MANIP_SERVO,    new float[] {0f, 0.7f}             )),
                new AutoState(new AutoState.ContinueCondition(   AutoState.ContinueType.TIME,    500L,   15), new AutoState.StateAction(AutoState.ActionType.DRIVE,          new float[] {0.6f,0,0}             )),
