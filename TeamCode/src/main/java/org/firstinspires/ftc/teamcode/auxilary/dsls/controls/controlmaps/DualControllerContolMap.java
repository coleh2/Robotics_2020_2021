...
public class DualControllerContolMap extends ControlMap {
    ...
    public static String drum = "scale(ternary(dpadUp, -1, ternary(dpadDown, 1, ternary(gamepad2DpadDown, 1, ternary(leftTrigger, -1, ternary(gamepad2DpadUp, -1, 0))))), 0.65)";
    ...
    public static String wobbleArmRight = "ternary(leftBumper, 0.086, 0.055)";
    public static String wobbleArmLeft = "ternary(leftBumper, 0.086, 0.055)";
