...
public class DualControllerContolMap extends ControlMap {
    ...
    public static String wobbleGrabRight = "toggleBetween(greaterThan(rightTrigger, 0.2), 1, 0)";
    public static String wobbleGrabLeft = "toggleBetween(greaterThan(rightTrigger, 0.2), 1, 0)";
    public static String wobbleArmRight = "toggleBetween(or(leftBumper, rightBumper), 0.086, 0.055)";
    public static String wobbleArmLeft = "toggleBetween(or(leftBumper, rightBumper), 0.086, 0.055)";
