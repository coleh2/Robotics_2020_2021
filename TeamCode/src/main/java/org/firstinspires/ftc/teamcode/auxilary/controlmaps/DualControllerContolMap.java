...
public class DualControllerContolMap extends ControlMap {
    ...
    public static String flywheelRight = "scale(ternary(gamepad2Cross, -0.3, ternary(gamepad2LeftTrigger, 1, 0)), -1)";
    public static String flywheelLeft  = "scale(ternary(gamepad2Cross, -0.3, ternary(gamepad2LeftTrigger, 1, 0)), 1)";
