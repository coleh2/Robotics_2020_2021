...
public class DualControllerContolMap extends ControlMap {
    ...
    public static String spinnyThingUpTop = "ternary(dpadUp, 0.2, ternary(dpadDown, -0.1, ternary(gamepad2DpadDown, -0.1, ternary(leftTrigger, 0.1, ternary(gamepad2Cross, 0.1, ternary(gamepad2DpadUp, 0.1, 0))))))";
    public static String shooterArm = "ternary(greaterThan(gamepad2RightTrigger, 0.1), 0.3, 1)";
    public static String flywheel = "gamepad2LeftTrigger";
    ...
    public static String wobbleArmRight = "ternary(gamepad2LeftBumper, 1, 0.2164)";
    public static String wobbleArmLeft = "ternary(gamepad2LeftBumper, 1, 0.2164)";
    ...
    public static String shooterStop = "ternary(greaterThan(gamepad2RightTrigger, 0.1), 0.25, 0.57)";
