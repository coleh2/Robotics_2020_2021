...
public class DualControllerContolMap extends ControlMap {
    ...
    public static String spinner = "ternary(dpadRight, 0.2, ternary(gamepad2DpadRight, 0.2, ternary(gamepad2Cross, -0.1, ternary(dpadLeft, -0.1, ternary(leftTrigger, 0.1, 0)))))";
    public static String shooterArm = "ternary(greaterThan(gamepad2RightTrigger, 0.1), 0.3, 1)";
    public static String flywheel = "scale(ternary(gampepad2Triangle, -0.3, ternary(greaterThan(gamepad2LeftTrigger, 0.3), 1, 0)), 1)";;
