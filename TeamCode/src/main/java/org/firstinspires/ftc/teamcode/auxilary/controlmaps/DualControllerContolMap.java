...
public class DualControllerContolMap extends ControlMap {
    ...
    public static String wobbleGrabRight = "toggle(greaterThan(rightTrigger, 0.2), 0, 1)";
    public static String wobbleGrabLeft = "toggle(greaterThan(rightTrigger, 0.2), 1, 0)";
