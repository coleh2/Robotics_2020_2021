...
public class DualControllerContolMap extends ControlMap {
    public static String drive = "ternary( or(or(leftStickY, leftStickX), rightStickX), scale(vector3(deadzone(leftStickY, 0.1), deadzone(leftStickX, 0.05), rightStickX), ternary(rightStickX, 0.5, 0.65)), vector3(scale(deadzone(gamepad2LeftStickY, 0.1), 0.2), scale(deadzone(gamepad2LeftStickX, 0.05), 0.2), scale(gamepad2RightStickX, 0.2)))";
    ...
    public static String shooterArm = "ternary(greaterThan(gamepad2RightTrigger, 0.1), 0, 0.57)";
    public static String flywheelRight = "scale(ternary(gamepad2Cross, -0.3, ternary(greaterThan(gamepad2LeftTrigger, 0.3), 1, 0)), -1)";
    public static String flywheelLeft  = "scale(ternary(gamepad2Cross, -0.3, ternary(greaterThan(gamepad2LeftTrigger, 0.3), 1, 0)), 1)";
